...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> 添加人才信息
        </div>
...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="talent_save.action" method="post"  enctype="multipart/form-data" >  
        <!-- 表单内容显示 -->
  ...
  个人资料
      ...
      <tr>
		 ...
		 <td rowspan="7"><label class="control-label">上传照片</label><s:file name="photo"></s:file></td>
      </tr>
      <tr><td>婚姻状况:
  ...
  简历
       ...
       <tr>
	   <td colspan="1"><label class="control-label">上传原始简历</label><s:file name="oldResume"></s:file></td>
	   <td colspan="2"><label class="control-label">上传标准简历</label><s:file name="standardResume"></s:file></td>
	   </tr>
</table>
            </div>
        </div>			
