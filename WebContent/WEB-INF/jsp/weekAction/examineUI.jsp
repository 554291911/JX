 ...
 <s:form action="week_examine.action" >
  ...
  <div class="ItemBlockBorder">
       ...
       <table class="table table-bordered" id="tab" cellpadding="0" cellspacing="0" >
		...
		<tr align="center">
			<td>员工姓名</td><td><s:textfield name="employeeName"></s:textfield></td><td>完成日期</td><td><input type="text" name="endDate" value="${endDate }" /></td>
		...
		<tr>
			<td>审批意见</td>
			<td colspan="3"><s:textarea name="remarks" cols="150" rows="5"></s:textarea></td>
		</tr>				
</table>
</div>
</div>
