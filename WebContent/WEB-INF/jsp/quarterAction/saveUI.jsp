...
<div id="Title_bar">
  <div id="Title_bar_Head">
    ...
    <div id="Title">
      <!--页面标题-->
      <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/>添加重点工作 </div>
  ...
  <!--显示表单内容-->
 <div id="MainArea">
 <s:form action="quarter_save.action" >
  <div class="ItemBlockBorder">
            <div class="ItemBlock">
 <table class="table table-bordered" >
		<thead><h3 align="center"><s:textfield name="year"></s:textfield>年<s:textfield name="month"></s:textfield>月重点工作</h3></thead>
		<tr>
			<td>接收人</td>
			<td><s:textfield name="accepter"></s:textfield></td>
			<td>接收时间</td>
			<td><input type="text" name="acceptDate"/></td>
			<td>要求完成时间</td>
