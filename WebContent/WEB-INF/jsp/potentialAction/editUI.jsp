...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> 编辑潜在客户信息
        </div>
...
<!--显示表单内容-->
<div id=MainArea>
	 <s:form action="potential_edit.action" >
            ...
            <div class="ItemBlock">
                <table  class="table table-bordered" >
                	<tr align="CENTER" valign="MIDDLE">	
						<td >猎头顾问</td>
                        <td><s:textfield name="headHunting" cssClass="InputStyle2" /></td>              
                  		<td>发起时间</td>
                 ...
                 <tr align="CENTER" valign="MIDDLE"><td >潜在客户名称</td>
					...
					<td>公司简介</td>
                        <td colspan="3">
						<s:textarea cols="150" rows="5" name="introduction" />
						</td>
                    </tr align="CENTER" valign="MIDDLE">
                     <tr align="CENTER" valign="MIDDLE">		
					 <td>招聘岗位</td>
                    ...
                    <tr align="CENTER" valign="MIDDLE"><td>初次联系时间</td>
                        <td colspan="3"><input type="text" name="firstContactTime"  value="${firstContactTime }"></td>
                    </tr>
                    ...
                    <tr align="CENTER" valign="MIDDLE"><td>再次联系时间</td>
                        <td colspan="3"><input type="text" name="againContactTime" value="${againContactTime }"/></td>
                    </tr>
